...
export const useNavigation = () => {
  ...
  { groupId: 'G01', id:'network',icon:'🕸',label:'Knowledge Graph', href: '/admin/knowledge-graph', pip:{cls:'green',n:'LIVE'}},
  ...
  const ADMIN_TABS=[{id:'dashboard',l:'Dashboard'},{id:'data',l:'Data Mgmt'},{id:'network',l:'Knowledge Graph'},{id:'feasibility',l:'Feasibility'},{id:'gap',l:'Skill Gap'},{id:'cluster',l:'Clusters'},{id:'analytics',l:'Graph Analytics'}];
